...
const Dashboard = () => {
  ...
  // Redirect logged-in user automatically to their feature page
  if (user) {
    if (user.isAdmin) {
      navigate('/admin'); // Admin goes to admin page
    } else {
      navigate('/create-report'); // Regular user goes to their page
    }
    return null; // prevent Dashboard content from flashing
  }

  return (
    <div className="dashboard">
      {/* No Navbar for non-logged-in users */}
      {!user && (
